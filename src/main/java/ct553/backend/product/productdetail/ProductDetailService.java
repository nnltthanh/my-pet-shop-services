...
import ct553.backend.product.service.PetServiceVariant;
...
public class ProductDetailService {
    ...
    public void add(ProductDetail productDetail, ImageData imageData) {
        ...
        if (product != null) {
            ...
            if (productDetail.getInventoryStatus() == null) {
                if (productDetail.getQuantity() > 0 || product instanceof ServiceProduct) {
    ...
    public List<ProductDetailDTO> getAllProductDetails(Long productId) {
